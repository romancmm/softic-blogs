        ...
        <Card hoverable size='small' className='h-full'>
            ...
            >
                <div className="w-1/3 h-20 bg-slate-50 overflow-hidden rounded">
                    <Image src={'/images/bg.jpeg'} alt={data?.title} height={100} width={150} className='object-cover h-full group-hover:scale-125 transition-500ms duration-500 delay-500 ease-in-out' />
                </div>
                <div className="w-2/3">
