    ...
    return (
        <div className="flex flex-col gap-1 border border-gray-200 p-4 rounded-xl">
            {blogs?.slice(5, 10)?.map((data: any, i: React.Key) =>
                <div className="flex items-start justify-start gap-4 py-1.5 border-b border-gray-200 border-spacing-6 border-separate border-dashed last:border-none last:pb-0 group">
